const TwentyNineteen = [
    ...
    },
    {
        ...
        text: 'As part of some R&D for UCLan I designed some Subject Pages',
        github: 'https://github.com',
        linktype: 'Live Project',
        demo: 'https://xd.adobe.com/view/55c478a8-d319-4703-7058-33a044c5cd27-23f5/?fullscreen'
    },
    {
        id: 3,
        image: 'https://github.com/Swinny96/Portfolio-22/blob/main/src/images/projects/eyesight.png?raw=true',
        title: 'EyeSight',
        text: 'I made an prototype for an mobile app that would allow users to view and manage all their optical care',
        github: 'https://github.com',
        linktype: 'Live Project',
